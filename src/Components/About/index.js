                    ...
                    <div id="teamPics" className="col-12 col-sm-5 col-md-12 mb-3">
                        <div className="row">
                            <div className="col-12 col-md-6">
                                <img className="pic img-fluid rounded-circle mb-3" src="./assets/images/Team/elise.png" alt="zeese" />
                                <h3 className="m-0">Elise</h3>
                                <h5 className="mb-5">Lead Decorator</h5>
                            </div>
                            <div className="col-12 col-md-6">
                                <img className="pic rounded-circle mb-3" src="./assets/images/Team/collin.png" alt="coco" />
